...
function activate(context) {
    context.subscriptions.push(vscode.commands.registerCommand("agentReviewer.reviewFile", handleReviewFile), vscode.commands.registerCommand("agentReviewer.reviewSelection", handleReviewSelection), vscode.commands.registerCommand("agentReviewer.reviewDiff", handleReviewDiff));
}
function deactivate() {
    // Nothing to clean up
}
